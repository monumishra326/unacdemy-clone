		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
						I am a Fronted Developer based in Noida. I build
						things for web.
					</h1>
					<div className={styles.btn}>
						<a
							href='https://drive.google.com/file/d/1bfgQWhOppi6rOX3x0q1kxIQuUSyLUjS_/view?usp=sharing'
							target='_blank'
						>
							<Button
								text={
				...
				>
					<img
						src='https://raw.githubusercontent.com/monumishra326/Monu-portfolio/main/10.jpg'
						alt='Profile pic'
					/>
				</div>
			</div>
			...
			>
				...
				>
					<Experiences />
					{/* "Monu is not only great for development, he is a problem
